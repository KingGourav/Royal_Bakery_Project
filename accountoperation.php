...
$query = "SELECT * FROM account WHERE CONCAT(id,date,debit,credit,remark) LIKE '%$se%'";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
...
while ($result = mysqli_fetch_assoc($data)) {
  echo " <tbody>
    <tr>
     ...
     <td><a class='btn btn-primary' href='deleteaccount.php?a=$result[id]'onclick='return checkdelete()'>Delete</a></td>
