...
<html lang="en">
  ...
  <script src="https://kit.fontawesome.com/9d33041dbc.js" crossorigin="anonymous"></script>
    ...
    <title>Category Operations Form </title>
...
<script>
  ...
  <div><h1>Royal Bakers Shop</h1></div>
    ...
    <div><h5><span>Contact number :-</span>   +91 9415453334</h5></div>
      ...
      <div class="one">
       <h2><i class="fas fa-dice-d6"style="margin-right: 1rem;"></i> Total No of Category<span><?php echo ($total); ?></span></h2>
...
$query = "SELECT * FROM category WHERE CONCAT(id,name,dis) LIKE '%$se%'";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
...
<td>".$result['dis']."</td>
 ...
 <td><a class='' href='updatecategory.php?a=$result[id]&b=$result[name]&c=$result[dis]
'>Edit</a></td>

     <td><a class='' href='deletecategory.php?a=$result[name]'onclick='return checkdelete()'>Delete</a></td>
