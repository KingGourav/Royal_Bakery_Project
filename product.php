...
<body>
	...
	<div class="main-wrapper1">
		...
		<div class="nav-background">
			<div class="mobile-logo" data-aos="fade-up"><img src="logo.png" alt="" style="width: 5rem;height: 5rem;margin-left: 4rem;"></div>
			<div class="mobile-nav">
				<div class="cart flex align-item ">
					<div>
						
						<a href="#" style="font-weight: bold;color: var(--primary);">Royal Bakers Shop</a>
					</div>
				</div>
				<div class="nav-top" data-aos="fade-up">
					...
					<li><a href="bill.php">Biling</a></li>
	...
	<header>
		<div class="container">
			...
			<div><a href="index.html">Home</a>
					...
					<a href="https://www.youtube.com/channel/UCV0C0oewU-Jnsg58nz4CX_Q">Youtube</a>
					<a href="app.html">Download App</a>
					<a href="bill.php">Billing</a></div>
		</div>
	...
	<section class="search">
		<div class="container">
			   ...
			   <input type="text" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search'];}?>"  placeholder="Search what do you want under ther category">
